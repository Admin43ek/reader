...
bool 盒子空投(char *gname, char **name) {
     if (strstr(gname, "CharacterDeadInventoryBox_C") != nullptr)
    {
        *name = "盒子";
        return true;
    }
        if (strstr(gname, "_TrainingBoxListWrapper_C") != nullptr)
    {
        *name = "盒子";
        return true;
    }
    if (strstr(gname, "PickUpListWrapperActor") != nullptr)
    {
        *name = "盒子";
        return true;
    }
    if (strstr(gname, "CharacterDeadInventory_C") != nullptr)
    {
        *name = "盒子";
        return true;
    }
    if (strstr(gname, "_AirDropPlane_C") != nullptr)
    {
        *name = "空投飞机";
        return true;
    }
    if (strstr(gname, "_AirDropPlane_SuperPeople_C") != nullptr)
    {
        *name = "空投飞机";
        return true;
    }
    if (strstr(gname, "_AirDropBox_C") != nullptr)
    {
        *name = "空投盒子";
        return true;
    }
    if (strstr(gname, "_AirDropBox_SuperPeople_C") != nullptr)
    {
        *name = "空投盒子";
        return true;
    }
